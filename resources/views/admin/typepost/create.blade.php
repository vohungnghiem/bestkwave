...
@section('title', 'Admincp | Create Type of Post')
@section('content')
@if (session('error'))
...
<div class="content-wrapper">
    ...
    <section class="content">
        <form method="POST" action="{{url('admincp/typepost/store')}}" autocomplete="off" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="sort" value="{{$sort}}" class="form-control " id="title" placeholder="sort" style="width:100px" >
                            </div> 
                            <div class="form-group">
