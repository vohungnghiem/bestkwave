...
@section('title', 'Admincp | Create Send Subscribe')
@section('content')
@if (session('error'))
...
<div class="content-wrapper">
    ...
    <section class="content">
        <form method="POST" action="{{url('admincp/sub/subsend/store')}}" autocomplete="off" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-5">
                    <div class="card">
