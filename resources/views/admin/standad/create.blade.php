...
@section('title', 'Admincp | Create Stand Advertisement')
@section('content')
@if (session('error'))
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Stand Advertisement</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <form method="POST" action="{{url('admincp/standad/store')}}" autocomplete="off" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-5">
                    <div class="card">
